...
___
## Поправить ошибки с доступами во время коммита
...
---
## Переключится на новую удалённую ветку локально
```
git checkout -q --track origin/2195-fix-login-page-styles
```
- Создаем одноименную локальную ветку
- добавляем её отслеживание одноименной удалённой ветки
- сразу переключаемся на новую ветку
